...
public abstract class Parser extends LexArith{
	...
	static HashMap<String, FuncDef> funcDefMap = new HashMap<>();
	...
	public static FuncDef funcDef(){
		...
		Body body = body();
		FuncDef def = new FuncDef(header,body);
		String funcName = header.funcName.id.id;
		funcDefMap.put(funcName,def);
		return def;
	}
